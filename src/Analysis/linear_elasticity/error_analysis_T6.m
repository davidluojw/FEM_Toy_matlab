    ...
    for ee = 1 : model.nel
        ...
        for ll = 1:model.nint
            ...
            for aa = 1:model.nen
                ...
                x_l = x_l + x_ele(aa) * T6_ShapeBasisN_2d(aa, xi(ll), eta(ll), zeta(ll));
                y_l = y_l + y_ele(aa) * T6_ShapeBasisN_2d(aa, xi(ll), eta(ll), zeta(ll));
                ux_l = ux_l + ux_ele(aa) * T6_ShapeBasisN_2d(aa, xi(ll), eta(ll), zeta(ll));
                uy_l = uy_l + uy_ele(aa) * T6_ShapeBasisN_2d(aa, xi(ll), eta(ll), zeta(ll));

                [Na_xi, Na_eta] = T6_ShapeBasisN_Grad_2d(aa, xi(ll), eta(ll));
