function plot_displacement_T6(model)
    ...
    hold off;
     ...
     plot_displacement_contour_T6(model, 1);  % u_x
     plot_displacement_contour_T6(model, 2);  % u_y
     plot_displacement_contour_T6(model, 3);  % u_abs
