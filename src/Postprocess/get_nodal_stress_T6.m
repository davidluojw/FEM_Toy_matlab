function model = get_nodal_stress_T6(model, ee)
    ...
    for ee = 1:model.nel
        ...
        for ii = 1 : model.nen
            ...
            [N1_xi, N1_eta] = T6_ShapeBasisN_Grad_2d(1, xi(ii), eta(ii));
            [N2_xi, N2_eta] = T6_ShapeBasisN_Grad_2d(2, xi(ii), eta(ii));
            [N3_xi, N3_eta] = T6_ShapeBasisN_Grad_2d(3, xi(ii), eta(ii));
            [N4_xi, N4_eta] = T6_ShapeBasisN_Grad_2d(4, xi(ii), eta(ii));
            [N5_xi, N5_eta] = T6_ShapeBasisN_Grad_2d(5, xi(ii), eta(ii));
            [N6_xi, N6_eta] = T6_ShapeBasisN_Grad_2d(6, xi(ii), eta(ii));
