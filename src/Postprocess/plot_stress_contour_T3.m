function plot_stress_contour_T3(model, type)
    ...
    for i = 1:model.nel
        ...
        if type == 1
            dd = [sxx(1), sxx(2), sxx(3), sxx(1)];
        elseif type == 2
            dd = [syy(1), syy(2), syy(3), syy(1)];
        elseif type == 3
            dd = [sxy(1), sxy(2), sxy(3), sxy(1)];
        elseif type == 4
            dd = [mises(1), mises(2), mises(3), mises(1)];
        end
        patch(XX,YY,dd);
        hold on;
    end
